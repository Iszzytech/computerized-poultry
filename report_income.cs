...
namespace Computerized_Poultry_Farm
{
    public partial class report_income : Form
    {
        ...
        private void report_income_Load(object sender, EventArgs e)
        {
            loadExpenseCat();
            try
            {
        ...
        private void btn_load_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM incomeRecord WHERE date >= '" + BPFromdate.Text + "' AND date <= '" + BPTodate.Text + "'", con);
            ...
            reportViewer1.LocalReport.ReportPath = @"C:\Users\Dell\Documents\Visual Studio 2015\Projects\Computerized Poultry Farm\Computerized Poultry Farm\Report_income.rdlc";
        ...
        private void loadExpenseCat()
        {
            ...
            {
                Etype.Items.Add(dr["income_cat"].ToString());
            }
        }
        ...
        private void gunaButton1_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-BD9VL65;Initial Catalog=pms;Integrated Security=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM incomeCat_tab WHERE income_cat = '" + Etype.SelectedItem.ToString() + "'", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
